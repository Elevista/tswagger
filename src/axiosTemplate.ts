...
const promiseWrapper = `export interface $customExtendResponse {}
${promiseEt}
...
const exportCode = (exportName: string, axiosCode: string) => `
...
const importTypes = (refTypes: string[], refPath: string) => `import { ${refTypes.join(', ')} } from '${refPath}'`
